...
type FlowsModalProps = {
  isOpen: boolean;
  onClose: () => void;
};

export default function FlowsModal({ isOpen, onClose }: FlowsModalProps) {
  ...
  const handleDeleteFlow = (e: React.MouseEvent, flowId: string, flowTitle: string) => {
